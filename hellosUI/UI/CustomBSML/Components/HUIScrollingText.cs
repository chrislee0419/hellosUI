...
namespace HUI.UI.CustomBSML.Components
{
    ...
    public class HUIScrollingText : MonoBehaviour
    {
        ...
        private void RecalculateElements(bool force = false)
        {
            ...
            else
            {
                ...
                {
                    string scaleString = ((int)(100 * (ScalingMinimumSizeRatio + 0.001f) / TextWidthRatio)).ToString("N0", CultureInfo.InvariantCulture);
